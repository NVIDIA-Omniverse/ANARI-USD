...
class UsdBridge
{
  public:
    ...
    void SetSamplerRef(UsdMaterialHandle material, UsdSamplerHandle sampler, const char* samplerImageUrl, bool samplerImageTimeVarying, double timeStep, double samplerTimeStep);
